...
<body>
    <div class="wrapper" style="background-color:#708090;width:80%;height:500px;margin-left:115px;margin-top:60px">
        ...
        @endif 
                <form action="/signups" role="form" method="POST">
                    @csrf
            <div class="panel-heading">
                <h3 class="panel-title" style="text-align:center;padding-top:10px">SignUp </h3>
            </div>
            <ul>
                <li style=""> 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="col-sm-offset-2">
                        <button type="submit" class="btn btn-mianeh" id="text_5">SignUp</button>
                    </div>
                    <div class="col-sm-offset-2 ">
                        <a href="http://127.0.0.1:8000/homee" id="hy">cancel</a>
                    </div>
                    <div class="col-sm-offset-2 " style="margin-left:320px;margin-top:-18px">
                        <a href="http://127.0.0.1:8000/logins/create" id="hy">Login</a>
                    </div>
            </div></li>
         </ul>
        </form>
